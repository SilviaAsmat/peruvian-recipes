...
export const recipes: Recipe[] = [
  {
      ...
      instructions: [
        ...
        "Add tomatoes and cook briefly so they stay slightly firm.",
    ...
    instructions: [
        ...
        "Add aji amarillo paste and cook briefly.",
        "Stir in the bread mixture and some chicken broth to form a sauce.",
        "Add shredded chicken and parmesan, simmer until thick and creamy."
      ]
    },
    {
    id: 3,
